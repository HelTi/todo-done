...
<img style="width:40%;" src="img/important.jpeg" align=center />

### 代办列表
代办列表是我的一天和重要清单的集合，你可以在该列表里查看所有类别的清单

<img style="width:40%;" src="img/list.jpeg" align=center />

### 代办详情
详情也可以设置重要、完成、是否添加到我的一天、是否设置过期时间、添加备注、删除。

<img style="width:40%;" src="img/detail.jpeg" align=center />
